...
across every run so that cross-condition comparisons are valid. The three
tasks are drawn from the NLUE benchmark \citep{nyachhyon2025nlue}; the models
are XLM-R base \citep{conneau2020xlmr}, mBERT \citep{devlin2019bert},
NepBERTa \citep{timilsina2022nepberta}, and IRIIS-RoBERTa
\citep{iriisroberta2024}. LoRA \citep{hu2022lora} uses rank
